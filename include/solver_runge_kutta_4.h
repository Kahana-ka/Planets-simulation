...
namespace rk4 {
	...
	/// Dato un vettore di planet_solver calcola i parameri k5 per l'equazioni dell'accellerazione
	/// Nei tre assi
	...
	/// Calcola il valore dell'argomento di f per calcolare k5 (w+...)
	...
	/// Dato un vettore di planet_solver calcola i parameri k4 per l'equazioni dell'accellerazione
	/// Nei tre assi
	/// @param self Pianeta per cui calcolare i k
	/// @param planets_solver Vector con tutti i pianeti
	/// @param h Grandezza dello step
	...
	/// Calcola il valore dell'argomento di f per calcolare k4 (w+...)
	/// @param param Valore iniziale del parametro (w)
	/// @param k1 Valore del coefficiente k1
	/// @param k2 Valore del coefficiente k2
	/// @param k3 Valore del coefficiente k3
	...
	/// Dato un vettore di planet_solver calcola i parametri k3 per l'equazioni dell'accellerazione
	/// Nei tre assi
	/// @param self Pianeta per cui calcolare i k
	/// @param planets_solver Vector con tutti i pianeti
	/// @param h Grandezza dello step
	...
	double next_point(double w, double k1, double k2, double k3, double k4,double k5);
	...
	class RK4_solver : public rk::RK_base {
	private:
		void next_step();
	...
	public:
		...
		RK4_solver(const std::vector<phy::Planet>&, double, double, double, double);
		RK4_solver(const std::vector<phy::Planet>&, double, double, double, double, std::string_view, bool, int);
